...
## Project Structure
    ...
    ├── jebathotta_jeyageet_40230  # Django project configurations
...
1. Clone this repo and `cd jebathotta_jeyageet_40230`
...
2. Clone this repo and `cd jebathotta_jeyageet_40230`
